...
| Unit     | What it covers                                                    | Owner                | Status                                        |
| -------- | ----------------------------------------------------------------- | -------------------- | --------------------------------------------- |
| **P1**   | Directories (i)(j)(k) and learning library (m): schema, Zod, seed | Alieu (Alieu-Claude) | Done except routes — PR #17, waits on B3/B4   |
| **UI**   | Web portal screens on fixture data: shell, directories, library   | Alieu (Alieu-Claude) | PR #18 (stacked on #17)                       |
| **UI-2** | Re-skin ("The Register") and Farmers screens                      | Alieu (Alieu-Claude) | Parked, unfinished — `wip/ui-register-reskin` |
