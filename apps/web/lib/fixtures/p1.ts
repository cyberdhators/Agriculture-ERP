...
export const LEARNING_RESOURCES: readonly LearningResourceRow[] = [
  ...
  resource(2, {
    ...
    language: 'ar-juba',
    format: 'pdf',
    storage_path: 'placeholder/sorghum-planting-guide-ar-juba.pdf',
    byte_size: 2_101_248,
    description: 'Arabi Juba edition of the sorghum planting guide.',
  ...
  resource(5, {
    ...
    description: 'Draft. Needs Arabi Juba subtitles before it goes out.',
    published: false,
  ...
  resource(8, {
    ...
    language: 'ar-juba',
    format: 'image',
    storage_path: 'placeholder/market-day-checklist-ar-juba.png',
    byte_size: 287_744,
  ...
  resource(9, {
    ...
    language: 'ar-juba',
    format: 'audio',
    storage_path: 'placeholder/seasonal-forecast-ar-juba.mp3',
    byte_size: 5_242_880,
