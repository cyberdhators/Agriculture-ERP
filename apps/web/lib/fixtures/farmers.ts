...
function makeRing(seed: number, lon: number, lat: number, targetHa: number, points: number): Ring {
  ...
  for (let k = 0; k < points; k++) {
    ...
    ring.push([
      Number((lon + dx / mx).toFixed(6)),
      Number((lat + dy / my).toFixed(6)),
    ] as const);
  }
  ring.push(ring[0]!);
  return ring;
...
function jubaCentre(i: number): [number, number] {
  ...
  return [
    Number((31.54 + r() * 0.18).toFixed(5)),
    Number((4.78 + r() * 0.16).toFixed(5)),
  ];
}
...
const SEEDS: Seed[] = [
  ...
  { g: 'Mary', f: 'Aluel', sex: 'f', yob: 1988, phone: '921000101', payam: 'CE-JUB-REJ', src: 'officer', status: 'verified', officer: 3, nid: '99A2211455', lang: 'en', createdDaysAgo: 41, sync: 'synced', farms: [{ targetHa: 1.8, accuracy: 'good', gps: 4, crops: ['sorghum', 'cowpea'], centre: C(1) }, { targetHa: 0.6, accuracy: 'good', gps: 6, crops: ['groundnut'], centre: C(2) }] },
  { g: 'John', f: 'Ladu', sex: 'm', yob: 1979, phone: '921000102', payam: 'CE-JUB-REJ', src: 'officer', status: 'verified', officer: 3, nid: '99B7781200', lang: 'en', createdDaysAgo: 38, sync: 'synced', farms: [{ targetHa: 2.4, accuracy: 'good', gps: 5, crops: ['sorghum'], centre: C(3) }] },
  { g: 'محمد', f: 'إدريس', sex: 'm', yob: 1972, phone: '921000103', payam: 'CE-JUB-KAT', src: 'officer', status: 'verified', officer: 1, nid: '99C5540098', lang: 'ar-juba', createdDaysAgo: 52, sync: 'synced', farms: [{ targetHa: 1.1, accuracy: 'good', gps: 7, crops: ['sesame', 'maize'], centre: C(4) }] },
  { g: 'Grace', f: 'Nyandeng', sex: 'f', yob: 1995, phone: '921000104', payam: 'CE-JUB-MUN', src: 'officer', status: 'verified', officer: 2, nid: null, lang: 'en', createdDaysAgo: 33, sync: 'synced', farms: [{ targetHa: 0.9, accuracy: 'good', gps: 5, crops: ['groundnut'], centre: C(5) }] },
  { g: 'Peter', f: 'Lomoro', sex: 'm', yob: 1984, phone: '921000105', payam: 'CE-JUB-NBA', src: 'officer', status: 'verified', officer: 4, nid: '99D1122334', lang: 'en', createdDaysAgo: 60, sync: 'synced', farms: [{ targetHa: 3.0, points: 5, accuracy: 'good', gps: 4, crops: ['maize', 'sorghum'], centre: C(6) }] },
  { g: 'فاطمة', f: 'عبد الله', sex: 'f', yob: 1990, phone: '921000106', payam: 'CE-JUB-KAT', src: 'officer', status: 'verified', officer: 1, nid: '99E8890011', lang: 'ar-juba', createdDaysAgo: 47, sync: 'synced', farms: [{ targetHa: 0.4, accuracy: 'poor', gps: 22, crops: ['sesame'], centre: C(7) }] },
  { g: 'Rebecca', f: 'Kiden', sex: 'f', yob: 1986, phone: '921000107', payam: 'CE-JUB-MUN', src: 'officer', status: 'verified', officer: 2, nid: '99F3345566', lang: 'en', createdDaysAgo: 29, sync: 'synced', farms: [{ targetHa: 1.4, accuracy: 'good', gps: 6, crops: ['groundnut', 'cowpea'], centre: C(8) }] },
  { g: 'Emmanuel', f: 'Taban', sex: 'm', yob: 1968, phone: '921000108', payam: 'CE-JUB-REJ', src: 'officer', status: 'verified', officer: 3, nid: '99G1200349', lang: 'en', createdDaysAgo: 71, sync: 'synced', farms: [{ targetHa: 2.1, accuracy: 'good', gps: 5, crops: ['sorghum'], centre: C(9) }] },
  { g: 'Josephine', f: 'Poni', sex: 'f', yob: 1993, phone: '921000109', payam: 'CE-JUB-NBA', src: 'officer', status: 'verified', officer: 4, nid: null, lang: 'en', createdDaysAgo: 26, sync: 'synced', farms: [{ targetHa: 0.7, accuracy: 'good', gps: 8, crops: ['maize'], centre: C(10) }] },
  { g: 'David', f: 'Sebit', sex: 'm', yob: 1981, phone: '921000110', payam: 'CE-JUB-KAT', src: 'officer', status: 'verified', officer: 1, nid: '99H9988770', lang: 'en', createdDaysAgo: 44, sync: 'synced', farms: [{ targetHa: 1.6, accuracy: 'good', gps: 6, crops: ['sesame', 'groundnut'], centre: C(11) }] },

  // — pending within 7 days —
  { g: 'Agnes', f: 'Yar', sex: 'f', yob: 1997, phone: '921000111', payam: 'CE-JUB-MUN', src: 'officer', status: 'pending', officer: 2, nid: null, lang: 'en', createdDaysAgo: 3, sync: 'synced', farms: [{ targetHa: 0.8, accuracy: 'good', gps: 7, crops: ['groundnut'], centre: C(12) }] },
  { g: 'Simon', f: 'Deng', sex: 'm', yob: 1975, phone: '921000112', payam: 'CE-JUB-REJ', src: 'officer', status: 'pending', officer: 3, nid: '99J4455661', lang: 'en', createdDaysAgo: 5, sync: 'sending', farms: [{ targetHa: 1.9, accuracy: 'good', gps: 5, crops: ['sorghum'], centre: C(13) }] },
  { g: 'Nadia', f: 'Kuku', sex: 'f', yob: 2001, phone: '921000113', payam: 'CE-JUB-NBA', src: 'self', status: 'pending', officer: null, nid: null, lang: 'en', createdDaysAgo: 2, sync: 'waiting', farms: [{ targetHa: 0.3, accuracy: 'poor', gps: 18, crops: ['cowpea'], centre: C(14) }] },
  { g: 'Bakri', f: 'Musa', sex: 'm', yob: 1963, phone: '921000114', payam: 'CE-JUB-KAT', src: 'officer', status: 'pending', officer: 1, nid: '99K7712093', lang: 'ar-juba', createdDaysAgo: 6, sync: 'synced', farms: [{ targetHa: 1.2, accuracy: 'good', gps: 9, crops: ['sesame'], centre: C(15) }] },

  // — pending PAST 7 days: escalated —
  { g: 'Christine', f: 'Amaya', sex: 'f', yob: 1991, phone: '921000115', payam: 'CE-JUB-MUN', src: 'officer', status: 'pending', officer: 2, nid: null, lang: 'en', createdDaysAgo: 12, sync: 'synced', farms: [{ targetHa: 0.9, accuracy: 'good', gps: 6, crops: ['groundnut'], centre: C(16) }] },
  { g: 'Moses', f: 'Lako', sex: 'm', yob: 1958, phone: '921000116', payam: 'CE-JUB-REJ', src: 'officer', status: 'pending', officer: 3, nid: '99L3390022', lang: 'en', createdDaysAgo: 21, sync: 'failed', reason: 'server_error', farms: [{ targetHa: 2.7, points: 5, accuracy: 'good', gps: 5, crops: ['sorghum', 'maize'], centre: C(17) }] },
  { g: 'Hanan', f: 'Osman', sex: 'f', yob: 1999, phone: '921000117', payam: 'CE-JUB-KAT', src: 'self', status: 'pending', officer: null, nid: null, lang: 'ar-juba', createdDaysAgo: 16, sync: 'waiting', farms: [{ targetHa: 0.5, accuracy: 'unusable', gps: 41, noBoundary: true, crops: ['sesame'], centre: C(18) }] },
  { g: 'Isaac', f: 'Wani', sex: 'm', yob: 1987, phone: '921000118', payam: 'CE-JUB-NBA', src: 'officer', status: 'pending', officer: 4, nid: '99M8801245', lang: 'en', createdDaysAgo: 9, sync: 'synced', resubmitted: true, farms: [{ targetHa: 1.3, accuracy: 'good', gps: 7, crops: ['maize'], centre: C(19) }] },

  // — duplicate: SAME PHONE as Simon Deng (index 12) —
  { g: 'Susan', f: 'Deng', sex: 'f', yob: 1994, phone: '921000112', payam: 'CE-JUB-REJ', src: 'self', status: 'pending', officer: null, nid: null, lang: 'en', createdDaysAgo: 4, sync: 'waiting', farms: [{ targetHa: 0.6, accuracy: 'poor', gps: 15, crops: ['cowpea'], centre: C(20) }] },

  // — duplicate: SAME NAME + PAYAM as Grace Nyandeng (index 4) —
  { g: 'Grace', f: 'Nyandeng', sex: 'f', yob: 1996, phone: '921000119', payam: 'CE-JUB-MUN', src: 'officer', status: 'pending', officer: 2, nid: null, lang: 'en', createdDaysAgo: 8, sync: 'sending', farms: [{ targetHa: 0.7, accuracy: 'good', gps: 8, crops: ['groundnut'], centre: C(21) }] },

  // — rejected —
  { g: 'Thomas', f: 'Gore', sex: 'm', yob: 1990, phone: '921000120', payam: 'CE-JUB-REJ', src: 'officer', status: 'rejected', officer: 3, nid: null, lang: 'en', createdDaysAgo: 34, sync: 'synced', reject: 'National ID could not be confirmed and no farm boundary was captured. Re-register with either an ID or a walked boundary.', farms: [{ targetHa: 0.4, accuracy: 'unusable', gps: 55, noBoundary: true, crops: ['sorghum'], centre: C(22) }] },
  { g: 'Betty', f: 'Achan', sex: 'f', yob: 2003, phone: '921000121', payam: 'CE-JUB-KAT', src: 'self', status: 'rejected', officer: null, nid: null, lang: 'en', createdDaysAgo: 40, sync: 'synced', reject: 'Under the programme age floor for a lead farmer; recorded but not counted toward reach.', farms: [] },

  // — merged: this duplicate points at Mary Aluel (index 1) as survivor —
  { g: 'Mary', f: 'Aluat', sex: 'f', yob: 1988, phone: '921000122', payam: 'CE-JUB-REJ', src: 'self', status: 'pending', officer: null, nid: null, lang: 'en', createdDaysAgo: 30, sync: 'synced', mergedIntoIdx: 1, farms: [{ targetHa: 1.7, accuracy: 'poor', gps: 19, crops: ['sorghum'], centre: C(1) }] },

  // — more verified / pending to fill the register —
  { g: 'Daniel', f: 'Juma', sex: 'm', yob: 1982, phone: '921000123', payam: 'CE-JUB-MUN', src: 'officer', status: 'verified', officer: 2, nid: '99N5567781', lang: 'en', createdDaysAgo: 55, sync: 'synced', farms: [{ targetHa: 1.0, accuracy: 'good', gps: 6, crops: ['groundnut', 'maize'], centre: C(23) }] },
  { g: 'Rose', f: 'Iko', sex: 'f', yob: 1998, phone: '921000124', payam: 'CE-JUB-NBA', src: 'officer', status: 'verified', officer: 4, nid: null, lang: 'en', createdDaysAgo: 49, sync: 'synced', farms: [{ targetHa: 0.8, accuracy: 'good', gps: 7, crops: ['maize'], centre: C(24) }] },
  { g: 'Yusuf', f: 'Idris', sex: 'm', yob: 1970, phone: '921000125', payam: 'CE-JUB-KAT', src: 'officer', status: 'verified', officer: 1, nid: '99P2234981', lang: 'ar-juba', createdDaysAgo: 63, sync: 'synced', farms: [{ targetHa: 2.2, points: 5, accuracy: 'good', gps: 5, crops: ['sesame', 'sorghum'], centre: C(25) }] },
  { g: 'Lily', f: 'Modi', sex: 'f', yob: 1992, phone: '921000126', payam: 'CE-JUB-REJ', src: 'officer', status: 'verified', officer: 3, nid: '99Q9911002', lang: 'en', createdDaysAgo: 36, sync: 'synced', farms: [{ targetHa: 1.5, accuracy: 'good', gps: 6, crops: ['cowpea'], centre: C(26) }] },
  { g: 'Michael', f: 'Bul', sex: 'm', yob: 1977, phone: '921000127', payam: 'CE-JUB-MUN', src: 'officer', status: 'verified', officer: 2, nid: '99R4478123', lang: 'en', createdDaysAgo: 58, sync: 'synced', farms: [{ targetHa: 1.9, accuracy: 'good', gps: 5, crops: ['groundnut'], centre: C(27) }] },
  { g: 'Esther', f: 'Lujang', sex: 'f', yob: 2000, phone: '921000128', payam: 'CE-JUB-NBA', src: 'self', status: 'pending', officer: null, nid: null, lang: 'en', createdDaysAgo: 1, sync: 'waiting', farms: [{ targetHa: 0.3, accuracy: 'poor', gps: 24, crops: ['cowpea'], centre: C(28) }] },
  { g: 'Samuel', f: 'Kenyi', sex: 'm', yob: 1985, phone: '921000129', payam: 'CE-JUB-REJ', src: 'officer', status: 'verified', officer: 3, nid: '99S3312890', lang: 'en', createdDaysAgo: 45, sync: 'synced', farms: [{ targetHa: 2.5, points: 5, accuracy: 'good', gps: 4, crops: ['sorghum', 'sesame'], centre: C(29) }] },
  { g: 'Nyakong', f: 'Gatwech', sex: 'f', yob: 1989, phone: '921000130', payam: 'CE-JUB-KAT', src: 'officer', status: 'verified', officer: 1, nid: null, lang: 'en', createdDaysAgo: 51, sync: 'synced', farms: [{ targetHa: 1.1, accuracy: 'good', gps: 8, crops: ['maize'], centre: C(30) }] },
  { g: 'Robert', f: 'Lomingo', sex: 'm', yob: 1966, phone: '921000131', payam: 'CE-JUB-MUN', src: 'officer', status: 'verified', officer: 2, nid: '99T7789004', lang: 'en', createdDaysAgo: 67, sync: 'synced', farms: [{ targetHa: 1.4, accuracy: 'good', gps: 6, crops: ['groundnut', 'cowpea'], centre: C(31) }] },
  { g: 'Amina', f: 'Hassan', sex: 'f', yob: 1994, phone: '921000132', payam: 'CE-JUB-KAT', src: 'officer', status: 'pending', officer: 1, nid: null, lang: 'ar-juba', createdDaysAgo: 4, sync: 'synced', farms: [{ targetHa: 0.6, accuracy: 'good', gps: 9, crops: ['sesame'], centre: C(32) }] },
  { g: 'Charles', f: 'Data', sex: 'm', yob: 1983, phone: '921000133', payam: 'CE-JUB-NBA', src: 'officer', status: 'verified', officer: 4, nid: '99U1145678', lang: 'en', createdDaysAgo: 42, sync: 'synced', farms: [{ targetHa: 1.7, accuracy: 'good', gps: 5, crops: ['maize', 'sorghum'], centre: C(33) }] },
  { g: 'Faiza', f: 'Ahmed', sex: 'f', yob: 1996, phone: '921000134', payam: 'CE-JUB-KAT', src: 'self', status: 'pending', officer: null, nid: null, lang: 'ar-juba', createdDaysAgo: 14, sync: 'failed', reason: 'no_network', farms: [{ targetHa: 0.5, accuracy: 'poor', gps: 20, crops: ['sesame'], centre: C(34) }] },
  { g: 'George', f: 'Loro', sex: 'm', yob: 1978, phone: '921000135', payam: 'CE-JUB-REJ', src: 'officer', status: 'verified', officer: 3, nid: '99V6634019', lang: 'en', createdDaysAgo: 39, sync: 'synced', farms: [{ targetHa: 2.0, accuracy: 'good', gps: 6, crops: ['sorghum'], centre: C(35) }] },
  { g: 'Winnie', f: 'Adau', sex: 'f', yob: 2002, phone: '921000136', payam: 'CE-JUB-MUN', src: 'officer', status: 'verified', officer: 2, nid: null, lang: 'en', createdDaysAgo: 31, sync: 'synced', farms: [{ targetHa: 0.9, accuracy: 'good', gps: 7, crops: ['groundnut'], centre: C(36) }] },
  { g: 'Philip', f: 'Ohisa', sex: 'm', yob: 1973, phone: '921000137', payam: 'CE-JUB-NBA', src: 'officer', status: 'verified', officer: 4, nid: '99W2290871', lang: 'en', createdDaysAgo: 64, sync: 'synced', farms: [{ targetHa: 2.8, points: 5, accuracy: 'good', gps: 4, crops: ['maize', 'cowpea'], centre: C(37) }] },
  { g: 'Sandra', f: 'Keji', sex: 'f', yob: 1990, phone: '921000138', payam: 'CE-JUB-KAT', src: 'officer', status: 'verified', officer: 1, nid: '99X5567234', lang: 'en', createdDaysAgo: 48, sync: 'synced', farms: [{ targetHa: 1.2, accuracy: 'good', gps: 6, crops: ['sesame', 'groundnut'], centre: C(38) }] },
  { g: 'Andrew', f: 'Tombe', sex: 'm', yob: 1980, phone: '921000139', payam: 'CE-JUB-REJ', src: 'officer', status: 'pending', officer: 3, nid: '99Y1178903', lang: 'en', createdDaysAgo: 11, sync: 'synced', farms: [{ targetHa: 1.6, accuracy: 'good', gps: 5, crops: ['sorghum'], centre: C(39) }] },
  { g: 'Margaret', f: 'Ropani', sex: 'f', yob: 1995, phone: '921000140', payam: 'CE-JUB-MUN', src: 'officer', status: 'verified', officer: 2, nid: null, lang: 'en', createdDaysAgo: 37, sync: 'synced', farms: [{ targetHa: 0.8, accuracy: 'good', gps: 8, crops: ['groundnut', 'maize'], centre: C(40) }] },

  // — out-of-state (Western Equatoria): only admin should see these —
  { g: 'Paul', f: 'Bagara', sex: 'm', yob: 1984, phone: '921000141', payam: 'WE-YAM-YAM', src: 'officer', status: 'verified', officer: 0, nid: '99Z3312004', lang: 'en', createdDaysAgo: 53, sync: 'synced', farms: [{ targetHa: 2.3, accuracy: 'good', gps: 6, crops: ['maize'], centre: [28.4, 4.57] }] },
  { g: 'Joyce', f: 'Bakhita', sex: 'f', yob: 1991, phone: '921000142', payam: 'WE-MRD-MRD', src: 'officer', status: 'pending', officer: 0, nid: null, lang: 'en', createdDaysAgo: 18, sync: 'synced', farms: [{ targetHa: 0.7, accuracy: 'poor', gps: 21, crops: ['groundnut'], centre: [29.47, 4.92] }] },
];
...
SEEDS.forEach((seed, i) => {
  ...
  if (seed.resubmitted) {
    ...
    verificationEvents.push({
      ...
      reason: 'Farm boundary missing on first submission. Returned to the officer to walk the plot.',
...
export function totalAreaHa(farmerId: string): number {
  return Number(farmsForFarmer(farmerId).reduce((sum, f) => sum + f.area_ha, 0).toFixed(2));
}
